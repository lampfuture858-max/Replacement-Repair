    ...
    if (casesContainer && casesContent) {
        ...
        var casesData = {
            's1': [
                ...
                { name: '法拉盛中餐馆厨房下水漏水', problem: '厨房下水管接头滴水半个月，楼下卖场天花板被泡坏，曾经多家维修报价高昂。', solution: '拆检接头并清理油污，更换耐高温密封胶与螺栓，加装防震垫圈，半小时交付使用。', feedback: '⭐⭐⭐⭐⭐ "报价透明、效率超快，餐厅当晚就恢复营业。"', location: '📍 法拉盛缅街', time: '⏱ 2024年9月' },
            ...
            's2': [
                { name: '皇后区整栋楼主下水道堵塞', problem: '四层住宅楼主下水道长期返水，多家公司建议挖街换管，报价昂贵。', solution: '电脑摄像定位堵塞在街管接口，直接使用高压水机清除油脂杂物，3 小时免挖街恢复排水。', feedback: '⭐⭐⭐⭐⭐ "省了6000多块！还不用破坏街道。对比其他公司的报价，真是天壤之别。"', location: '📍 皇后区牙买加', time: '⏱ 2024年8月' },
            ...
            's4': [
                ...
                { name: '曼哈顿热水炉延寿保养', problem: '使用 30 年的储水式热水炉不出热水，多位维修工建议整机更换。', solution: '检测后仅更换温度传感器与加热棒，并清洗水垢，恢复热水供应。', feedback: '⭐⭐⭐⭐⭐ "节省了几千块的换机费用，热水量比以前还稳定。"', location: '📍 曼哈顿中城', time: '⏱ 2024年3月' },
...
window.casesList = {
    ...
    s4: {
        ...
        cases: [
            { name: '布朗士暖气炉突然停止工作', problem: '1月严寒，暖气炉突然不工作，房间温度急剧下降。业主急坏了，打遍了紧急热线都排队很久。', solution: '杨师傅30分钟内上门（比其他公司快得多），发现是电路故障 + 燃烧器积碳。清理积碳、更换点火器，暖气恢复正常。', tags: ['快速上门', '紧急维修', '快速恢复'], tagColors: ['bg-red-100 text-red-700', 'bg-orange-100 text-orange-700', 'bg-yellow-100 text-yellow-700'], feedback: '⭐⭐⭐⭐⭐ "真的救了我的命！冬天没有暖气我真活不了。杨师傅的应急反应速度一流！"', location: '📍 布朗士莫里尼亚', time: '⏱ 2024年1月' },
            { name: '曼哈顿热水炉老化需要更换', problem: '30年的热水炉不再供应热水，维修工都建议得换新炉。但新炉要$4000+，非常贵。', solution: '杨师傅查看后发现只是温度传感器和加热棒需要换，不必整炉更换。只花小部分钱就完全恢复了热水供应。', tags: ['精准诊断', '部件更换', '省钱方案'], tagColors: ['bg-yellow-100 text-yellow-700', 'bg-orange-100 text-orange-700', 'bg-red-100 text-red-700'], feedback: '⭐⭐⭐⭐⭐ "帮我省了3000多块钱！诚实的维修工现在太少了，必须推荐。"', location: '📍 曼哈顿中城', time: '⏱ 2024年3月' },
